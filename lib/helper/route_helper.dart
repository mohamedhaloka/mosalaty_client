...
class RouteHelper {
  ...
  static String getOrderSuccessRoute(
      String orderID, String status, bool parcel) {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return getRoute(MapScreen(
              fromStore: Get.parameters['page'] == 'store', address: _data));
        }),
    ...
    GetPage(
        ...
        page: () => getRoute(OrderSuccessfulScreen(
              ...
              success: Get.parameters['status'].contains('success'),
    ...
    GetPage(
        ...
        page: () => getRoute(ParcelRequestScreen(
              ...
              pickedUpAddress: AddressModel.fromJson(jsonDecode(utf8.decode(
                  base64Url
                      .decode(Get.parameters['picked'].replaceAll(' ', '+'))))),
