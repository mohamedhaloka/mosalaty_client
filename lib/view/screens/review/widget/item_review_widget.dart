                    ...
                    return Container(
                      ...
                      child: Column(children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              ...
                              children: [
                                Text(
                                    widget.orderDetailsList[index].itemDetails
                                        .name,
                                    style: robotoMedium,
                                    maxLines: 2,
                            ...
                            Row(children: [
                              ...
                              Text(
                                widget.orderDetailsList[index].quantity
                                    .toString(),
                                style: robotoMedium.copyWith(
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              return InkWell(
                                child: Icon(
                                  itemController.ratingList[index] < (i + 1)
                                      ? Icons.star_border
                                      : Icons.star,
                                  size: 25,
                                  color:
                        ...
                        MyTextField(
                          ...
                          onChanged: (text) =>
                              itemController.setReview(index, text),
                        ),
                        SizedBox(height: 20),
                        ...
                        Padding(
                          ...
                          child: !itemController.loadingList[index]
                              ? CustomButton(
                                  buttonText: itemController.submitList[index]
                                      ? 'submitted'.tr
                                      : 'submit'.tr,
                                  onPressed: itemController.submitList[index]
                                      ? null
                                      : () {
                                          if (!itemController
                                              .submitList[index]) {
                                            if (itemController
                                              ...
                                              ReviewBody reviewBody =
                                                ...
                                                productId: widget
                                                    ...
                                                    .id
                                                    .toString(),
                                                rating: itemController
                                                    .ratingList[index]
                                                    .toString(),
                                                comment: itemController
                                                    .reviewList[index],
                                                orderId: widget
                                                    .orderDetailsList[index]
                                                    .orderId
