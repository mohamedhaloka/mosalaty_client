    ...
    return Scaffold(
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        return paginatedOrderModel != null
            ? paginatedOrderModel.orders.length > 0
                ? RefreshIndicator(
                    onRefresh: () async {
                      if (isRunning) {
                      ...
                      child: FooterView(
                        child: SizedBox(
                          ...
                          child: PaginatedListView(
                            ...
                            totalSize: paginatedOrderModel != null
                                ? paginatedOrderModel.totalSize
                                : null,
                            offset: paginatedOrderModel != null
                                ? paginatedOrderModel.offset
                                : null,
                            itemView: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                bool _isParcel = paginatedOrderModel
                                    ...
                                    Get.toNamed(
                                      ...
                                      arguments: OrderDetailsScreen(
                                        orderId: paginatedOrderModel
                                            .orders[index].id,
                                        orderModel:
                                            paginatedOrderModel.orders[index],
                                      ),
                                    );
                                  },
                                  child: Container(
                                          ...
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CustomImage(
                                                ...
                                                height: _isParcel ? 35 : 60,
                                                width: _isParcel ? 35 : 60,
                                                fit: _isParcel
                                                    ? null
                                                    : BoxFit.cover,
                                              ),
