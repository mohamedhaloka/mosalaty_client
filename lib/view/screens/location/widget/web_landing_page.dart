...
class _WebLandingPageState extends State<WebLandingPage> {
              ...
              child: Column(children: [
                ...
                Stack(children: [
                  ClipRRect(
                    ...
                    child: Opacity(
                        opacity: 0.05,
                        child: Image.asset(Images.landing_bg,
                            height: 130,
                            width: context.width,
                            fit: BoxFit.fill)),
                  ),
                    ...
                    child: Row(children: [
                      Expanded(
                          ...
                          child: Padding(
                            ...
                            child: Column(children: [
                              Image.asset(Images.landing_choose_location,
                                  height: 70, width: 70),
                              SizedBox(
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'choose_your_location_to_start_shopping'.tr,
                ...
                GetBuilder<SplashController>(builder: (splashController) {
                  if (splashController.moduleList != null && _timer == null) {
                    _timer = Timer.periodic(Duration(seconds: 5), (timer) {
                      int _index = splashController.moduleIndex >=
                ...
                SizedBox(
                    height: AppConstants.whyChooseUsList.length > 0 ? 40 : 0),
                ...
                _config.toggleDmRegistration
                    ? RegistrationCard(isStore: false)
                    : SizedBox(),
  ...
  List<Widget> _generateChooseUsList() {
    ...
    for (int index = 0; index < AppConstants.whyChooseUsList.length; index++) {
      _chooseUsList.add(Expanded(
          child: Row(children: [
        Expanded(
            child: LandingCard(
                icon: AppConstants.whyChooseUsList[index].icon,
                title: AppConstants.whyChooseUsList[index].title.tr)),
        SizedBox(
