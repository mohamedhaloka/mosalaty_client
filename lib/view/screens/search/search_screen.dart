                          ...
                          child: Row(children: [
                            ...
                            Expanded(
                              ...
                              iconPressed: () => _actionSearch(
                                  false, _searchController.text.trim(), false),
                                    ...
                                    children: [
                                      ...
                                      (_isLoggedIn &&
                                              searchController
                                                      .suggestedItemList !=
                                                  null)
                                          ? searchController.suggestedItemList
                                                      .length >
                                                  0
                                              ? GridView.builder(
                                                  gridDelegate:
  ...
  void _actionSearch(bool isSubmit, String queryText, bool fromHome) {
    if (Get.find<SearchController>().isSearchMode || isSubmit) {
      ...
      Get.dialog(FilterWidget(
          maxValue: _maxValue, isStore: Get.find<SearchController>().isStore));
    }
  }
}
