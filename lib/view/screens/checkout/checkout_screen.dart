              ...
              if (locationController.addressList != null) {
                for (int index = 0;
                  ...
                  if (Get.find<LocationController>()
                      .getUserAddress()
                      .zoneIds
                      .contains(locationController.addressList[index].zoneId)) {
                    _addressList.add(DropdownMenuItem<int>(
                        value: index,
                        child: SizedBox(
                          width: context.width > Dimensions.WEB_MAX_WIDTH
                                      ...
                                      children: [
                                        ...
                                        _isDigitalPaymentActive
                                            ? PaymentButton(
                                                ...
                                                isSelected: _isCashOnDeliveryActive
                                                    ? orderController
                                                            .paymentMethodIndex ==
                                                        1
                                                    : orderController
  ...
  void _callback(bool isSuccess, String message, String orderID) async {
    if (isSuccess) {
      ...
      if (_isCashOnDeliveryActive &&
        ...
        Get.offNamed(
            RouteHelper.getOrderSuccessRoute(orderID, 'success', false));
      } else {
        if (GetPlatform.isWeb) {
          ...
          String selectedUrl =
              '${AppConstants.BASE_URL}/payment-mobile?order_id=$orderID&&customer_id=${Get.find<UserController>().userInfoModel.id}&&callback=$protocol//$hostname${RouteHelper.orderSuccess}?id=$orderID'
