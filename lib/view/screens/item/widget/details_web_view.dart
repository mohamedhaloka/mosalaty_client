  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      ...
      return SingleChildScrollView(
        ...
        constraints:
            BoxConstraints(minHeight: MediaQuery.of(context).size.height - 560),
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: CustomImage(
                                      fit: BoxFit.cover,
                                      image:
                                          '${Get.find<SplashController>().configModel.baseUrls.itemImageUrl}/${_imageList[itemController.productSelect]}',
                                    ),
                                  ),
                                  SizedBox(height: 10),
                                  Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(children: [
                                      QuantityButton(
                                        isIncrement: false,
                                        quantity: itemController.cartIndex != -1
