    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child:
              Text('campaigns'.tr, style: robotoMedium.copyWith(fontSize: 24)),
        ),
        campaignController.itemCampaignList != null
            ? GridView.builder(
                ...
                itemCount: campaignController.itemCampaignList.length > 3
                    ? 4
                  ...
                  return InkWell(
                    onTap: () {
                      Get.find<ItemController>().navigateToItemPage(
                          campaignController.itemCampaignList[index], context,
                          isCampaign: true);
                    },
                    child: Container(
                      decoration: BoxDecoration(
                            ...
                            Stack(children: [
                              ...
                              DiscountTag(
                                discount: campaignController
                                        ...
                                        0
                                    ? campaignController
                                        .itemCampaignList[index].storeDiscount
                                    : campaignController
                                ...
                                fromTop: Dimensions.PADDING_SIZE_LARGE,
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        campaignController
                                            .itemCampaignList[index].storeName,
                                        style: robotoMedium.copyWith(
                                            fontSize:
