...
class WebPopularStoreView extends StatelessWidget {
  ...
  WebPopularStoreView(
      {@required this.storeController, @required this.isPopular});

  @override
  Widget build(BuildContext context) {
    List<Store> _storeList = isPopular
                    ...
                    onTap: () {
                      Get.toNamed(
                        RouteHelper.getStoreRoute(
                            _storeList[index].id, 'store'),
                        arguments: StoreScreen(
                            store: _storeList[index], fromModule: false),
                      );
                    },
                    child: Container(
                      width: 500,
                            ...
                            Stack(children: [
                              ...
                              DiscountTag(
                                ...
                                discountType: storeController
                                    .getDiscountType(_storeList[index]),
                                freeDelivery: _storeList[index].freeDelivery,
                              ),
                              storeController.isOpenNow(_storeList[index])
                                  ? SizedBox()
                                      ...
                                      if (Get.find<AuthController>()
                                        ...
                                        _isWished
                                            ? wishController.removeFromWishList(
                                                _storeList[index].id, true)
                                            : wishController.addToWishList(
                                                null, _storeList[index], true);
                                      } else {
                                        showCustomSnackBar(
